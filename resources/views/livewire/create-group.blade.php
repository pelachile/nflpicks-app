...
<div class="max-w-2xl mx-auto p-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Create New Group</h1>
        ...
        <form wire:submit.prevent="createGroup" class="space-y-6">
            ...
            <div>
                ...
                @enderror
                <p class="mt-1 text-sm text-gray-500">{{ strlen($name) }}/50 characters</p>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-sm text-gray-500">{{ strlen($description) }}/255 characters</p>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-sm text-gray-500">You can have up to 10 members in your group.</p>
            </div>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button
                    type="submit"
                    class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
