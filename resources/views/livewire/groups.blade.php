...
<div class="max-w-6xl mx-auto p-6">
    ...
    @else
        <div class="text-center py-12 bg-card rounded-lg shadow-md">
            ...
            <p class="text-primary/60 mb-4">Create a group or join and existing one to start competing with friends!</p>
            <a
                href="{{ route('groups.join') }}"
                wire:navigate
                class="bg-highlight text-white px-6 py-3 rounded-lg hover:bg-highlight/90 transition-colors"
            >
                Join Group
            </a>
            <a
